...
class QuizResolutionGuest extends StatefulWidget {
  final int id;
  final int salaId;
  final String salaName;
  final int asistenciaId;

  const QuizResolutionGuest(
      {required this.id,
  ...
  @override
  _QuizResolutionGuestState createState() => _QuizResolutionGuestState();
}

List<int> respuestas = [];

class _QuizResolutionGuestState extends State<QuizResolutionGuest> {
