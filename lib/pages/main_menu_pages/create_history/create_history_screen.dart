            ...
            child: GestureDetector(
              ...
              onTap: () async {
                await showCard(
                  'Zorro',
                  'assets/fox.jpg',
                  'El zorro es un mamifero que caza sobre todo por la noche. Durante el día permanece oculto entre los matorrales o en sus madrigueras, excavadas en parajes secos y escondidos, a menudo entre las rocas, los barrancos herbosos y las espesuras.',
                  getFox,
                ).then((value) => Navigator.pop(context));
              },
            ),
            ...
            child: GestureDetector(
              ...
              onTap: () async {
                await showCard(
                  'Pato',
                  'assets/duck.jpg',
                  'El pato es un ave acuática que es migradora y suele vivir cerca de hábitats de agua dulce o salada, como lagunas, pantanos, humedales o ríos.',
                  getDuck,
                ).then((value) => Navigator.pop(context));
              },
            ),
            ...
            child: GestureDetector(
              ...
              onTap: () async {
                await showCard(
                  'Pez',
                  'assets/fishes.jpg',
                  'Los peces son animales vertebrados primariamente acuáticos y con respiración por branquias. Suelen estar recubiertos por escamas, y están dotados de aletas, que permiten su movimiento continuo en los medios acuáticos, y branquias, con las que captan el oxígeno disuelto en el agua.',
                  getFish,
                ).then((value) => Navigator.pop(context));
              },
            ),
