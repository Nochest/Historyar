  ...
  Widget build(BuildContext context) {
    if (widget.isguest == false) {
      return Scaffold(
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          ...
                          onTap: () {
                            ...
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (BuildContext context) => MyForums(
                                      id: widget.id,
                                      type: widget.type,
                                      isguest: widget.isguest,
                                    )));
        ...
        bottomNavigationBar: historyarBottomAppBar(context, false, false, true,
